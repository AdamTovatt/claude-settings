...
3. **Determine the worktree path**: `../ordo-<branch-name>` (relative to the repo root). For example, branch `azure-session-lifetime-management` becomes `../ordo-azure-session-lifetime-management`.
